...
public class ServerThread extends Thread {
    ...
    // Mute command methods
    List<String> mutedUserList = new ArrayList<String>();
    public void mutedUser(String clientName)
    {
        mutedUserList.add(clientName);
    }

    protected void removeMutedUser(String clientName){
        mutedUserList.remove(clientName);
    }

    protected boolean mutedListCheck(String clientName){
        if (mutedUserList.contains(clientName)){
            return true;
        }
        else
            return false;
